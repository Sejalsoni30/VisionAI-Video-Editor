...
const Register = () => {
    ...
    const handleGoogleSignUp = async () => {
        ...
        try {
            ...
            // 2. ✅ Success! Dashboard skip karke seedha Editor par redirect
            console.log("System Authorized: Redirecting to Editor Workspace...");
            navigate('/editor');
    ...
    const handleEmailSignUp = async (e) => {
        ...
        try {
            ...
            navigate('/editor'); // 🚀 New user seedha editing start karega!
        } catch (error) {
            alert(error.message);
        } finally {
            setLoading(false);
    ...
    return (
        <div className="min-h-screen bg-[#020203] flex items-center justify-center p-6 font-inter text-white overflow-hidden relative">
            ...
            <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-purple-600/5 blur-[120px] rounded-full pointer-events-none" />
            ...
            >
                ...
                <div className="text-center mb-12">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full mb-4">
                        ...
                        <span className="text-[8px] font-black uppercase tracking-[0.3em] text-zinc-400">Join the Vision</span>
                    </div>

                    <h2 className="text-3xl font-black tracking-tighter uppercase italic">
                        Create <span className="text-blue-500 font-black">Account</span>
                    </h2>
                    <p className="text-zinc-500 text-sm mt-3 font-medium tracking-tight">Elevate your cinematic production.</p>
                </div>
                ...
                <div className="flex items-center gap-6 mb-10 opacity-30 text-zinc-500">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-[0.4em]">Protocol Sync</span>
                    <div className="h-[1px] flex-1 bg-white" />
                </div>
                ...
                <form onSubmit={handleEmailSignUp} className="space-y-5">
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="w-full bg-white/[0.03] border border-white/5 py-4 pl-14 pr-5 rounded-2xl outline-none focus:border-blue-500/50 focus:bg-white/[0.06] transition-all text-sm font-medium"
                ...
                <p className="text-center mt-12 text-zinc-600 text-xs font-medium tracking-tight">
                    System Access Authorized? <Link to="/login" className="text-blue-500 font-black ml-2 hover:underline transition-all">Sign In Node</Link>
                </p>
            </motion.div>
        </div>
    );
